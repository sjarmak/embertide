...
/**
 * Compatibility exports for the pre-embertide-v4x store type path.
 * Remove once all consumers import these domain types from `src/types/kidPlayer`.
 */
export type { ChampionId, KidPlayer } from '../types/kidPlayer';
